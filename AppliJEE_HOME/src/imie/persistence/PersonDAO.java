...
import imie.model.PersonDTO;

public class PersonDAO extends ADAO<PersonDTO>{
	...
	@Override
	public PersonDTO findOne(PersonDTO data) {
	...
	@Override
	public PersonDTO findOne(Integer i) {
	...
	@Override
	public PersonDTO insert(PersonDTO data) {
